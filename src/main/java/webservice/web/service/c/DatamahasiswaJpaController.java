...
import webservice.web.service.c.exceptions.NonexistentEntityException;
import webservice.web.service.c.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("webservice_web.service.c_jar_0.0.1-SNAPSHOTPU");
